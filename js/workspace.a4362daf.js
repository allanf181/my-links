parcelRequire = function (e, r, t, n) {
    ...
    "TCu9": [function (require, module, exports) {
        ...
        var a = function () {
            ...
            return r(t, [{
                key: "drawFrame", value: function (e, t, r, a, n, i) {
                    var o = this.frames[t], u = o.x, s = o.y, c = o.width, h = o.height;
    ...
    "Js4U": [function (require, module, exports) {
        ...
        var n = function () {
            ...
            return i(t, [{
                key: "main", value: function () {
                    var e = Date.now(), t = (e - this.lastTime) / 1e3;
    ...
    "oCom": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {value: !0}), exports.default = void 0;
        var t = o(require("./Sprite.js")), e = o(require("./Scene.js")), i = n(require("./Random.js"));
        ...
        var d = function (r) {
            ...
            return p(n, e.default), h(n, [{
                key: "sizeDidChange", value: function (t) {
                ...
                key: "createEntity", value: function () {
                    ...
                    return {
                        ...
                        speed: {x: a, y: 0},
                        size: s,
                        origin: {x: r ? -s.width : u, y: i.integerValue(0, l - s.height)},
                        opacity: o,
                        intrinsicSize: h
                    }
                }
                ...
                key: "render", value: function () {
                    var t = this.context, e = this.size, i = e.width, r = e.height;
                    ...
                    try {
                        for (var u, l = this.entities[Symbol.iterator](); !(n = (u = l.next()).done); n = !0) {
                            var h = u.value, s = h.sprite, c = h.animationFrame, f = h.origin, p = h.size,
                                y = h.opacity;
                ...
                key: "update", value: function (t) {
                    ...
                    var r = this.size.width, n = this.size.height, o = this.protagonist;
                    if (o || ((o = this.createEntity()).speed.x = 0, o.opacity = 1, this.entities.push(o), this.protagonist = o), o) {
                        var a = {width: Math.min(.8 * r, 600), height: Math.min(.8 * n, 600)}, u = o.intrinsicSize,
                            l = a.width / u.width, h = a.height / u.height, s = Math.min(l, h),
                            c = {width: u.width * s, height: u.height * s};
                        o.size = c, o.origin.x = Math.round(.5 * (r - c.width)), o.origin.y = Math.round(.5 * (n - c.height))
                    }
                    var f = [], p = 0, y = !0, d = !1, g = void 0;
                    try {
